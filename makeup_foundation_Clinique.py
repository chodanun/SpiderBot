...
def main():
	number_of_page = 1
	max_page = 9
	file_name = open("csv/foundations/makeup_foundation_clinique.csv", "w")

	while number_of_page <= max_page:
		url = "http://www.fishpond.co.nz/Beauty/Makeup/Face/Foundation/?brand=Clinique&cName=Beauty%2FMakeup%2FFace%2FFoundation&page="+str(number_of_page)
