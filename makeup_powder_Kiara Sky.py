...
def main():
	number_of_page = 1
	max_page = 7
	file_name = open("csv/powder/makeup_powder_Kiara Sky.csv", "w")

	while number_of_page <= max_page:
		url = "http://www.fishpond.co.nz/Beauty/Makeup/Face/Powder/?brand=Kiara%20Sky&cName=Beauty%2FMakeup%2FFace%2FPowder&page="+str(number_of_page)
