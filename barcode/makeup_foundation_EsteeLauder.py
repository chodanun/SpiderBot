...
def main():
	number_of_page = 1
	max_page = 8
	file_name = open("csv/foundations/makeup_foundation_EsteeLauder.csv", "w")

	while number_of_page <= max_page:
		url = "http://www.fishpond.co.nz/Beauty/Makeup/Face/Foundation/?brand=Estee%20Lauder&cName=Beauty%2FMakeup%2FFace%2FFoundation&page="+str(number_of_page)
