...
def main():
	number_of_page = 1
	max_page = 1
	file_name = open("csv/skincare/makeup_skincare_L'Oreal Paris.csv", "w")

	while number_of_page <= max_page:
		url = "http://www.fishpond.co.nz/Beauty/Skin_Care/Sun/Skin_Protection?brand=L%27Oreal+Paris&page="+str(number_of_page)
