...
def main():
	number_of_page = 1
	max_page = 3
	file_name = open("csv/skincare/makeup_skincare_Banana Boat.csv", "w")

	while number_of_page <= max_page:
		url = "http://www.fishpond.co.nz/Beauty/Skin_Care/Sun/Skin_Protection/?brand=Banana%20Boat&cName=Beauty%2FSkin_Care%2FSun%2FSkin_Protection&page="+str(number_of_page)
