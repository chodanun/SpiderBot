...
def main():
	number_of_page = 1
	max_page = 10
	file_name = open("csv/lips/makeup_lips_MAC.csv", "w")

	while number_of_page <= max_page:
		url = "http://www.fishpond.co.nz/Beauty/Makeup/Lips/?brand=MAC&cName=Beauty%2FMakeup%2FLips&page="+str(number_of_page)
