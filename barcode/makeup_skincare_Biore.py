...
def main():
	number_of_page = 1
	max_page = 1
	file_name = open("csv/skincare/makeup_skincare_Biore.csv", "w")

	while number_of_page <= max_page:
		url = "http://www.fishpond.co.nz/Beauty/Skin_Care/Sun/Skin_Protection?brand=Biore&page="+str(number_of_page)
