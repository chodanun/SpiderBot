...
def main():
	number_of_page = 1
	max_page = 3
	file_name = open("csv/powder/makeup_powder_Maybeline.csv", "w")

	while number_of_page <= max_page:
		url = "http://www.fishpond.co.nz/Beauty/Makeup/Face/Powder/?brand=Maybelline&cName=Beauty%2FMakeup%2FFace%2FPowder&page="+str(number_of_page)
